...
public class VerticalOrderBinaryTree {
     ...
     */
        ...
        private void putLevelsInHashMap(TreeNode A, int level ) {
            ...
            if( hashMap.get(level) == null ) {
                ...
                ArrayList<Integer> list = hashMap.get(level);
                list.add(A.val);
            }

            putLevelsInHashMap(A.left,--level);
            putLevelsInHashMap(A.right,++level);
        }
